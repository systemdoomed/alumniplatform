	...
	<form action="include/signup.inc.php" method="post">
		<div class="form-row">
				 	<div class="form-group col-xl-2">
				      <label for="inputtitle" class="text-light">Akademischer Titel</label>
			   ...
			   <div class="form-group col-xl-2">
			      ...
			      <input type="text" name="inputbirthname" class="form-control" id="inputbirthname" placeholder="Geburtsname">
			   </div>
        </div>
        <div class="form-row">
		 <div class="form-group col-xl-2">
