...
--
-- Host: localhost
-- Erstellungszeit: 15. Feb 2021 um 23:55
...
CREATE TABLE `Nutzer` (
  ...
  `company` varchar(60) COLLATE latin1_german1_ci DEFAULT NULL,
  `position` varchar(30) COLLATE latin1_german1_ci DEFAULT NULL,
